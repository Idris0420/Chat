 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zi=xS;function Uv(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:yh,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw Zn.create("bad-app-name",{appName:String(i)});if(n||(n=Dv()),!n)throw Zn.create("no-options");const s=hl.get(i);if(s){if(io(n,s.options)&&io(r,s.config))return s;throw Zn.create("duplicate-app",{appName:i})}const o=new H1(i);for(const u of _h.values())o.addComponent(u);const l=new FS(n,r,o);return hl.set(i,l),l}function xd(t=yh){const e=hl.get(t);if(!e&&t===yh&&Dv())return Uv();if(!e)throw Zn.create("no-app",{appName:t});return e}function Pt(t,e,n){var r;let i=(r=LS[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const l=[`Unable to register library "${i}" with version "${e}":`];s&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Sn.warn(l.join(" "));return}Jt(new jt(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function KS(t){Jt(new jt("platform-logger",e=>new oS(e),"PRIVATE")),Jt(new jt("heartbeat",e=>new qS(e),"PRIVATE")),Pt(gh,Wm,t),Pt(gh,Wm,"esm2017"),Pt("fire-js","")}KS("");var GS="firebase",QS="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Pt(GS,QS,"app");const Bv="@firebase/installations",Ld="0.6.9";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
